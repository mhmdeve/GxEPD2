...
// Panel: GDEY0154F51 : https://www.good-display.com/product/463.html
...
#include "GxEPD2_154c_GDEY0154F51.h"

GxEPD2_154c_GDEY0154F51::GxEPD2_154c_GDEY0154F51(int16_t cs, int16_t dc, int16_t rst, int16_t busy) :
  GxEPD2_EPD(cs, dc, rst, busy, LOW, 50000000, WIDTH, HEIGHT, panel, hasColor, hasPartialUpdate, hasFastPartialUpdate)
{
  _paged = false;
}

void GxEPD2_154c_GDEY0154F51::clearScreen(uint8_t value)
{
  clearScreen(value, 0xFF);
}

void GxEPD2_154c_GDEY0154F51::clearScreen(uint8_t black_value, uint8_t color_value)
{
  writeScreenBuffer(black_value, color_value);
  refresh();
}

void GxEPD2_154c_GDEY0154F51::writeScreenBuffer(uint8_t value)
{
  writeScreenBuffer(value, 0xFF);
}

void GxEPD2_154c_GDEY0154F51::writeScreenBuffer(uint8_t black_value, uint8_t color_value)
{
...
void GxEPD2_154c_GDEY0154F51::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_154c_GDEY0154F51::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  //Serial.print("writeImagePart("); Serial.print(x_part); Serial.print(", "); Serial.print(y_part); Serial.print(", ");
  //Serial.print(w_bitmap); Serial.print(", "); Serial.print(h_bitmap); Serial.print(", ");
...
void GxEPD2_154c_GDEY0154F51::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
...
void GxEPD2_154c_GDEY0154F51::writeNativePart(const uint8_t* data1, const uint8_t* data2, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!data1) return;
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
...
void GxEPD2_154c_GDEY0154F51::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_154c_GDEY0154F51::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_154c_GDEY0154F51::refresh(bool partial_update_mode)
{
  if (hasPartialUpdate) _setPartialRamArea(0, 0, WIDTH, HEIGHT);
  _refresh(partial_update_mode);
}

void GxEPD2_154c_GDEY0154F51::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
...
void GxEPD2_154c_GDEY0154F51::powerOff()
{
  _PowerOff();
}

void GxEPD2_154c_GDEY0154F51::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_154c_GDEY0154F51::setPaged()
{
  if (!hasPartialUpdate)
  {
    _paged = true;
...
void GxEPD2_154c_GDEY0154F51::_refresh(bool partial_update_mode)
{
...
void GxEPD2_154c_GDEY0154F51::_setPartialRamArea(uint16_t x, uint16_t y, uint16_t w, uint16_t h, bool partial_mode)
{
...
void GxEPD2_154c_GDEY0154F51::_PowerOn()
{
  if (!_power_is_on)
  {
    _writeCommand(0x04);
...
void GxEPD2_154c_GDEY0154F51::_PowerOff()
{
  if (_power_is_on)
  {
    _writeCommand(0x02);
...
void GxEPD2_154c_GDEY0154F51::_InitDisplay()
{
  if ((_rst >= 0) && (_hibernating || _initial_write))
  {
    delay(100); // At least 20ms delay
    digitalWrite(_rst, LOW); // Module reset
    delay(10);  // At least 40ms delay, 2ms for WS "clever" reset
    digitalWrite(_rst, HIGH);
    delay(10); // At least 50ms delay (32ms measured)
    while(1)
    {	 //=0 BUSY
